...
run_network_sampler <- function(adjacency_matrix, coefEdges, coefTwostars, coefTriangle, MCMC_interval = 1024L, MCMC_samplesize = 1024L, MCMC_burnin = 1024 * 16L, p_one_node_swap = 0.001, p_large_step = 0.001, p_invert = 0.001, lambda = 0.5, level = "info") {
    .Call(`_myergm_run_network_sampler`, adjacency_matrix, coefEdges, coefTwostars, coefTriangle, MCMC_interval, MCMC_samplesize, MCMC_burnin, p_one_node_swap, p_large_step, p_invert, lambda, level)
}

simulate_network <- function(adjacency_matrix, coefEdges, coefTwostars, coefTriangle, MCMC_interval = 1024L, MCMC_samplesize = 1024L, MCMC_burnin = 1024 * 16L, p_one_node_swap = 0.001, p_large_step = 0.001, p_invert = 0.001, lambda = 0.5, level = "info") {
    .Call(`_myergm_simulate_network`, adjacency_matrix, coefEdges, coefTwostars, coefTriangle, MCMC_interval, MCMC_samplesize, MCMC_burnin, p_one_node_swap, p_large_step, p_invert, lambda, level)
}

proposal_mvrnorm <- function(mu, sigma) {
