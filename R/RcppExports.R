...
count_edges <- function(adjmat) {
    .Call(`_myergm_count_edges`, adjmat)
}

count_triangle <- function(adjmat) {
    .Call(`_myergm_count_triangle`, adjmat)
}

update_one_link <- function(adjmat, numOfEdges, numOfTriangles, i, j, verbose) {
    .Call(`_myergm_update_one_link`, adjmat, numOfEdges, numOfTriangles, i, j, verbose)
}

update_all_links_of_one_node <- function(adjmat, i) {
    .Call(`_myergm_update_all_links_of_one_node`, adjmat, i)
}
